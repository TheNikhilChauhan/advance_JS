...
// const thor = new Person("Thor", "King of Asgard", "Javascript");
// console.log(thor);
// console.log(thor.__proto__);
// console.log(thor.__proto__.__proto__);
// console.log(thor.__proto__.__proto__.__proto__);
...
console.log(myArr.pop()); // POPING IT UP
